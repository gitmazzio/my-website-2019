<template>
  <div id="app">
    ...
    <ul id="menu">
      ...
      <li>
        <a
          href="https://linkedin.com/in/matteomazziotti"
          target="_blank"
          rel="noopener"
          class="icon__social"
          v-b-tooltip.hover
          title="@matteomazziotti"
        >
          <i>
      ...
      <li>
        <a
          href="https://twitter.com/teomazzio"
          target="_blank"
          rel="noopener"
          class="icon__social"
          v-b-tooltip.hover
      ...
      <li>
        <a
          href="https://www.instagram.com/milandreamin/"
          target="_blank"
          rel="noopener"
          class="icon__social"
          v-b-tooltip.hover
      ...
      <div class="section fp-auto-height" id="section4">
        <footer class="pt-4 pb-4">
          <div class="thanks-section">
            ...
            <p>
              Vue.js team:
              <a target="_blank" href="https://github.com/vuejs/vue">
                <i>
                  <svg
            ...
            <p>
              <a target="_blank" href="https://github.com/alvarotrigo/">alvarotrigo</a>:
              <a target="_blank" href="https://github.com/alvarotrigo/fullpage.js">
                <i>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="12"
                ...
                </i> fullpage.js library
              </a>
            </p>
            <p>
              Cover pic:
              <a target="_blank" href="https://www.instagram.com/_paulearl/">
                <i>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="12"
          ...
          <span style="font-size: small">© 2019 Matteo Mazziotti Some Rights Reserved</span>
        </footer>
      </div>
    </full-page>
  </div>
  ...
  data() {
    return {
      options: {
        ...
        menu: "#menu",
        navigation: true,
        anchors: ["hi", "aboutme", "contacts", "#thanks"],
